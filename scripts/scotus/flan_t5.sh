...
models=(
    "google/flan-t5-small,MAdAiLab/flan-t5-small_scotus"
    "google/flan-t5-base,MAdAiLab/flan-t5-base_scotus"
    "google-t5/t5-small,MAdAiLab/t5-small_scotus"
    "google-t5/t5-base,MAdAiLab/t5-base_scotus"    
)
